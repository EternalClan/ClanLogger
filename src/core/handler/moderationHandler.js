...
module.exports = (globalclient) => {
	...
	if (modulesEnabled !== "") {
		...
		console.log(`[${DateTime.utc().toFormat(timeFormat)}][core.moderationHandler.js] Moderation Handler loaded`);
	}
	if (modulesEnabled === "") console.log(`[${DateTime.utc().toFormat(timeFormat)}][core.moderationHandler.js] Moderation Handler Disabled`);
};