...
const Utils = {
	...
	/**
     * @param {String} string The Text as String
	 * @returns {String}
     */
	...
	/**
     * @param {String} str The Text Template
     * @param  {Array<String>} args The Words to replace with
	 * @returns {String}
     */
	parseReply(str, ...args) {
		let i = 0;
     ...
     * @param {Boolean} precise Toggle number precision
     */
	...
	/**
     * @param {String} env The envirement variable
	 * @returns {boolean}
     */
	test_ENV(env) {
		if (process.env[env]) {
	...
	/**
	 * @param {Number} seconds Rate Limit in Seconds
	 * @returns {String|null}
	 */
	...
	/**
	 * @param {Number} seconds Archive Duration in Seconds
	 * @returns {String|null}
	 */
	...
	/**
	 * @param {Number} bitfield System Channel Flags Bitfield
	 * @returns {String|null}
	 */
