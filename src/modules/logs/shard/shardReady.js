...
module.exports = {
	...
	async execute(shardId, unavailableGuilds) {
		...
		console.info(`[${DateTime.utc().toFormat(timeFormat)}][logs.shardReady.js] Shards ${shardId} ready.`);
		console.info(`[${DateTime.utc().toFormat(timeFormat)}][logs.shardReady.js] Guilds in Shards ${unavailableGuilds} unavailable.`);
	}
};